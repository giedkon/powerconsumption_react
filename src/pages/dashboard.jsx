        ...
        <>
            ...
            <div className="panel row mb-3">
                <div className="d-flex justify-content-center">
                    <LimitChart currentValue={Math.ceil(cost * 1000) / 1000} maxValue={powerLimit.maxValue} title={'Daily Power Usage'} prefix={'kWh'} />
                    <LimitChart currentValue={Math.ceil(cost * 100) / 100} maxValue={maxEnergyPriceLimit.maxValue} title={'Monthly Expenses'} prefix={'Eur'} />
                </div>
            </div>
